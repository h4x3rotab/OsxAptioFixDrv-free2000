...
// stinga11 - 0x6000
#define KERNEL_BLOCK_NO_RT_SIZE_PAGES	0x18000
...
//	MemoryIn = *Memory;
    //!! print
    Print(L"MOAllocatePages(type=%d, memtype=%d, pages=0x%x, addr=0x%x)\n", Type, MemoryType, NumberOfPages, *Memory);
    //!! end
